                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped table-responsive table-hover ">
                            ...
                            <tbody>
                            @foreach(Auth::user()->role === 'student' ? Auth::user()->scores : \App\Score::all()  as $score)
                                <tr>
                                    <td>{{ $score->id }}</td>
                                    <td>{{ \App\User::find($score->user_id)->name }}</td>
                                    <td>{{ \App\Course::find(\App\Examination::find($score->examination_id)->course_id)->name }}</td>
                                    <td>{{ \App\Examination::find($score->examination_id)->type }}</td>
                                    <td>{{ $score->score }} %</td>
                                </tr>
                            @endforeach
